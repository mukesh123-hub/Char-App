...
const filteredUsers = input
  ? users.filter((user) => user && user.fullName?.toLowerCase().includes(input.toLowerCase()))
  : users.filter((user) => user && user.fullName); 
  return (
        ...
        <div className='pb-5'>
            <div className='flex justify-between items-center'>
                ...
                <div className='relative py-2 group'>
                   ...
                   <div className='absolute top-full right-0 z-20 w-35 p-5 rounded-md bg-[#282142] border-gray-600 text-gray-100 hidden group-hover:block'>
            ...
            <div className='bg-[#282142] rounded-full mt-5 py-3 px-4 flex items-center gap-2'> 
